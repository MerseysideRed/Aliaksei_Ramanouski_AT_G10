...
public class TransportableProcessorRunner {
    public static void main(String[] args) {
        ...
        //transportableProcessor.runTransportable(flyableCopter); // There is a compilation error because flyable objects are related to Flyable interface, which doesn't have method move. So we can't transfer Flyable objects to method for Transportable objects.
        //transportableProcessor.runTransportable(flyablePlane);
        //transportableProcessor.runTransportable(flyableRocket);
        //transportableProcessor.runTransportable(rideableCar); There is a compilation error because rideable objects are related to Rideable interface, which doesn't have method move. So we can't transfer Rideable objects to method for Transportable objects.
        ...
        transportableProcessor.runTransportable(transportableMoped, 23, 242);
